    ...
    Rectangle{
        ...
        ColumnLayout{
            ...
            TabItem{
                ...
                onClicked: {
                    stackView.clear()
                    stackView.push("VirusKilling.qml")
                    header.title = ""
            ...
            TabItem{
                ...
                onClicked: {
                    stackView.clear()
                    stackView.push("qrc:/ParentalControl/ParentalControl.qml")
                    header.title = displayText
            ...
            TabItem{
                ...
                onClicked: {
                    stackView.clear()
                    stackView.push("qrc:/ExtensionTool/ExtensionTool.qml")
                    header.title = displayText
